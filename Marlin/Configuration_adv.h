...
#define DUAL_X_CARRIAGE
  ...
  #define X1_MAX_POS 304  // Set a maximum so the first X-carriage can't hit the parked second X-carriage
  #define X2_MIN_POS    -9       // Set a minimum to ensure the  second X-carriage can't hit the parked first X-carriage
...
//#define FWRETRACT
  ...
  #define FWRETRACT_AUTORETRACT           // costs ~500 bytes of PROGMEM
    ...
    #define MIN_AUTORETRACT 0           // When auto-retract is on, convert E moves of this length and over
    #define MAX_AUTORETRACT 0         // Upper limit for auto-retract conversion
  #endif
  #define RETRACT_LENGTH 0                // Default retract length (positive mm)
  #define RETRACT_LENGTH_SWAP 0          // Default swap retract length (positive mm), for extruder change
